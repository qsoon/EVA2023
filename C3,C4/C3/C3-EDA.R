...
par(mfrow=c(1,3))
plot(exp(-exp(-c3$Y1)),exp(-exp(-c3$Y2)),pch=".",main="F(Y1) vs. F(Y2)",asp=1, xlab="F(Y1)",ylab="F(Y2)")
plot(exp(-exp(-c3$Y1)),exp(-exp(-c3$Y3)),pch=".",main="F(Y1) vs. F(Y3)",asp=1, xlab="F(Y1)",ylab="F(Y3)")
plot(exp(-exp(-c3$Y2)),exp(-exp(-c3$Y3)),pch=".",main="F(Y2) vs. F(Y3)",asp=1, xlab="F(Y2)",ylab="F(Y3)")
...
plot(seq(2,10,by=0.1),
     ...
     xlab="r",ylab="Probability",main="P(Y1>r,Y2>r,Y3>r)",
...
plot(seq(2,10,by=0.1),
     ...
     xlab="r",ylab="Probability",main="P(Y1>r,Y2>r,Y3<m)",
     xlim=c(2,10),ylim=c(0.0,0.01))
lines(seq(2,10,by=0.1),
...
plot(seq(-2,10,by=0.1),
     ...
     xlab="r",ylab="Empirical probability",main="P(Y1>r,Y2>r,Y3>r)",
